...
<form class="form-horizontal" action = "/addProject" method = "post" commandName = "project">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                            ...
                            <div class="col-lg-8">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"></div>
                                        <div>
                                            <span class="btn btn-default btn-file"><span class="fileinput-new"><spring:message code="add.project.project.avatar.change.avatar"/></span><span class="fileinput-exists"><spring:message code="add.project.project.avatar.change"/></span><input type="file" name="avatar"></span>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn" data-dismiss="modal" aria-hidden="true"><spring:message code="add.project.close"/></button>
                    </div>
                </div>
            </div>
        </div>
